...
#client = LineClient()
client = LineClient(authToken='EuLyuNm7j8Fue1dvNcRf.zsjptOGse28bSLj1PuTA7W.Y64gtFK7lfERbjEuS9w5VxFPJxDM+8z4imHLjIE/2JE=')
                    ...
                    if msg.contentType == 0:
                        if msg.toType == 2:
                            ...
                            if text.lower() == 'me':
                                ...
                                start = time.time()
                                client.sendText(receiver, "SpeedBot")
                            ...
                            elif text.lower() == 'cctv':
                                if msg.to in cctv['point']:
                                    cctv['cyduk'][msg.to]=False
                                    client.sendText(msg.to, cctv['sidermem'][msg.to])
                                else:
                                    client.sendText(msg.to, "belom di Set bos")
                except Exception as e:
                ...
                try:
                    if cctv['cyduk'][op.param1]==True:
                        if op.param1 in cctv['point']:
                            ...
                            Np = client.getContact(op.param2).pictureStatus
                            if Name in cctv['sidermem'][op.param1]:
                                pass
                            else:
                                cctv['sidermem'][op.param1] += "\n~ " + Name
                                pref=['█۞███████]▄▄▄▄▄▄▄▄▄▄▃ ●●\n▂▄▅██D█O█R██▅▄▃▂…\n[███████████████████]\n◥⊙▲⊙▲⊙▲⊙▲⊙▲⊙▲⊙\n۞Tukang Intip»»ⓞ','╭━ SIDER✒D✒A✒ T✒ A✒N✒G✒✒\n╰╮┏━┳┳┳┓  ┏┳┳┳┳┳┓  ┏┳┳┳┳┳┓\n┏┻╋━╋┻┻┫  ┣┻┻┻┻┻┫  ┣┻┻┻┻┻┫\n┃SIDER▪┃ ◾' + Name + '┃\n┗ⓞ━━━ⓞ┻━┻ⓞ━━ⓞ┻━┻ⓞ━━ⓞ╯']
                                client.sendImageWithURL(op.param1, "http://dl.profile.line-cdn.net/" + Np)
